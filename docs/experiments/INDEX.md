...
| EXP-008 | drift | `drift_report.json` | yes | Feature/label drift vs train (IID) |
...
| EXP-013 | temporal_holdout | `temporal_holdout_report.json` | yes | Day-aware Friday holdout vs IID |
