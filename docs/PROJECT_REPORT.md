...
## 4. Related work (brief outline)

- Signature vs anomaly vs ML-based IDS literature  
- CICIDS2017 as a standard evaluation corpus  
- Explainable AI for security (SHAP, LIME)  
- SOAR / playbook concepts (recommendations as *advisory*, not auto-remediation)

*(Expand with 8–12 citations from your college library / Google Scholar.)*
